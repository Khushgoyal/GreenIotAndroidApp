...
public class moisture_se_chilli extends AppCompatActivity implements SensorEventListener
{

    TextView xValue;

    private static final String TAG = "moisture_se_chilli";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_moisture_chilli);
        ...
        if (sensor_humid != null)
        {
            ...
            sensorManager.registerListener(moisture_se_chilli.this, sensor_humid, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void writeToFile(String val)
    {
        ...
        try
        {
            ...
            File csv = new File(dir, "record_moisture.txt");
