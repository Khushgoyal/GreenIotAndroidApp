...
public class moisture_se_tomato extends AppCompatActivity implements SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_moisture_se_tomato);
        ...
        if (sensor_humid != null)
        {
            ...
            sensorManager.registerListener(moisture_se_tomato.this, sensor_humid, SensorManager.SENSOR_DELAY_NORMAL);
