...
public class light_se_chilli extends AppCompatActivity implements SensorEventListener , View.OnClickListener
{

    TextView xValue;

    private static final String TAG = "light_se_chilli";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_light_se_chilli);
        // return an object
        ...
        {
            sensorManager.registerListener(light_se_chilli.this, sensor_light, SensorManager.SENSOR_DELAY_NORMAL);// reading sensor without delay
       ...
       // mChart.setDescription("light data graph");
        ...
        chooseButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
            if(ContextCompat.checkSelfPermission(light_se_chilli.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED)
            {
                    chooseFile();
                }else
                ActivityCompat.requestPermissions(light_se_chilli.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
            }
        });
