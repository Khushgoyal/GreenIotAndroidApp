...
public class light_se extends AppCompatActivity implements SensorEventListener , View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_light_se);
        // return an object
        ...
        {
            sensorManager.registerListener(light_se.this, sensor_light, SensorManager.SENSOR_DELAY_NORMAL);// reading sensor without delay
       ...
       // mChart.setDescription("light data graph");
        ...
        chooseButton.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
            if(ContextCompat.checkSelfPermission(light_se.this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED)
            {
                    chooseFile();
                }else
                ActivityCompat.requestPermissions(light_se.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
            }
        });
    ...
    public void writeToFile(String val)
    {
        ...
        try
        {
            ...
            File csv = new File(dir, "record_stawberry_light.txt");
